...
//    }
    ...
    private void RequestBanner()
    {
        ...
        #elif UNITY_ANDROID
		string adUnitId = "ca-app-pub-3176182856663051/6875616394";
        #elif UNITY_IPHONE
		string adUnitId = "ca-app-pub-3176182856663051/2445416792";
        #else
    ...
    public void RequestInterstitial()
    {
            ...
            string adUnitId = "unused";
        #elif UNITY_ANDROID
		string adUnitId = "ca-app-pub-3176182856663051/8352349591";
        #elif UNITY_IPHONE
		string adUnitId = "ca-app-pub-3176182856663051/3922149991";
        #else
            string adUnitId = "unexpected_platform";
        #endif
