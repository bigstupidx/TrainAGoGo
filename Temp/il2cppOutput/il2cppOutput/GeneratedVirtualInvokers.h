...
struct VirtActionInvoker11
{
	...
	{
		VirtualInvokeData data = il2cpp::vm::Runtime::GetVirtualInvokeData (slot, obj);
		((Action)data.methodInfo->method)(data.target, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, data.methodInfo);
	}
};
...
struct VirtActionInvoker13
{
	...
	{
		VirtualInvokeData data = il2cpp::vm::Runtime::GetVirtualInvokeData (slot, obj);
		((Action)data.methodInfo->method)(data.target, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, data.methodInfo);
	}
};
